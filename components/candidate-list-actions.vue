    ...
    <ClientOnly>
        <div>
            <UButtonGroup size="md">
                ...
                <UButton icon="i-tabler-sparkles text-indigo" color="white" :loading="isGeneratingPromptCandidates" @click="isGeneratingCandidatesModalOpen = true">
                    Generate prompts
                </UButton>
